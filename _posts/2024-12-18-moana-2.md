...
* The emissive mesh importance sampling system that we implemented on the first Moana has seen many efficiency improvements [[Li et al. 2024]](https://doi.org/10.1145/3665320.367099).
...
* Since the first Moana, Hyperion's subdivision/tessellation system has gained an advanced fractured mesh system that makes many of the huge-scale effects in the first Moana movie much easier for us to create today [[Burley & Rodrigues 2022]](https://doi.org/10.1145/3532836.3536262).
...
* The original Moana used our somewhat ad-hoc first-generation denoiser, while Moana 2 uses our best-in-industry second-generation deep learning denoiser jointly developed by Disney Research Studios, Disney Animation, Pixar, and ILM [[Vogels et al. 2018](https://doi.org/10.1145/3197517.3201388), [Dahlberg et al. 2019](https://doi.org/10.1145/3306307.3328150)]. 
...
Yining Karl Li, Charlotte Zhu, Gregory Nichols, Peter Kutz, Wei-Feng Wayne Huang, David Adler, Brent Burley, and Daniel Teece. 2024. [Cache Points for Production-Scale Occlusion-Aware Many-Lights Sampling and Volumetric Scattering](https://doi.org/10.1145/3665320.367099). In _DigiPro 2024_. 6:1-6:19.
