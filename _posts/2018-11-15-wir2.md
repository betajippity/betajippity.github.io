...
Ralph Breaks the Internet is our first feature film to use Hyperion's new spectral and decomposition tracking [(Kutz et al. 2017)]() based null-collision volume rendering system exclusively.
