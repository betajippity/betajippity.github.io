...
**Addendum**: I added a personal project page for this paper to my website, [located here](http://www.yiningkarlli.com/projects/skydomecompare.html). My personal page mirrors the same content found on the main site, including an author's version of the paper, supplemental materials, and more.
